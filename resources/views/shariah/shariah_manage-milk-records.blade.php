...
@section('title', 'Manage Milk Records (Shariah)')
                    ...
                    <div class="record-item" 
                        ...
                        <div class="shariah-status">
                            @php
                                ...
                                $isReady = ($milk->milk_Status === 'Storage Completed');
                            @endphp

                            @if($isReady)
                                <a href="{{ route('shariah.shariah_view-milk-processing', $milk->milk_ID) }}" class="btn-{{ is_null($approval) ? 'review' : ($approval == 1 ? 'approved' : 'rejected') }}" title="Review this record">
                                    @if(is_null($approval))
                            ...
                            @else
                                <span class="status-tag status-pending">
                                    <i class="fas fa-clock"></i> Lab Processing
                                </span>
                            @endif
                        </div>
